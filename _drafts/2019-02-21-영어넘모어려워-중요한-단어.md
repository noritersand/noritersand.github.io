...
- production server: 운영(실) 서버. A production server is a server used to host website content and applications for deployment to a live environment. 
