...
### 디렉토리 vs 디렉터리
- 외래어 표기법을 따르면 디렉터리, 구글링 검색결과를 따르면 디렉토리가 맞음.
...
- 따옴표 대신 그레이브(\`)로 표현하는 문자열 리터럴
- ES2015에서 최초 정의
- 원래 명칭은 template strings 였으나 변경됨.
- https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Template_literals
- https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals

### [JavaScript] promise
- `_drafts\2017-02-03-javascript-promise.md`
...
### [misc] SAML
- SAML<sup>Security Assertion Markup Language</sup>
