...
- verb: 동사
  ...
  - plural-verb: 복수동사
- adjective: 형용사
- adverb: 부사 (very, usually, well, often, quickly, ...)
- preposition: 전치사 (before, during, for, on, at, from, of, ...)
- conjunction: 접속사 (and, but, or, for, so, because, when, if, until, ...)
...
(비록) …이긴 하지만, (앞에 말한 내용의 어조를 누그러뜨리기 위해 덧붙여) 그래도 …이기는 하다, (문장 끝에 와서) 그렇지만
