...
변수가 객체를 어떤식으로 가리키냐의 차이. 말 그대로 pass-by-value는 객체 자체(값)를 변수에 할당하며, pass-by-reference는 객체의 메모리 주소를 변수에 할당한다.

종종 자바나 자바스크립트, 파이썬 등의 언어는 변수에 객체를 가리키는 주소를 마치 값처럼 할당하기 때문에 pass-by-value다 라고 말하곤 하는데 엄밀히 따지면 [pass-by-object-reference](https://robertheaton.com/2014/02/09/pythons-pass-by-object-reference-as-explained-by-philip-k-dick/)다.
