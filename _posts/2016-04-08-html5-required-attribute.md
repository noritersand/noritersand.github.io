...
거의 똑같이 돌아가긴 하지만 [`HTMLFormElement.reportValidity()`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLFormElement/reportValidity)는 IE에서 지원하지 않는 문제가 있다. 익스 없는 세상은 언제 오나.
