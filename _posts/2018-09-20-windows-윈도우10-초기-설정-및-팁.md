...
그 다음, WSL 2를 쓸 생각이 없다면 바로 서브 시스템을 설치하면 된다. Miscrosoft Store에서 'wsl'로 검색하면 나오는 앱 중 하나를 골라 설치하거나:

![](/images/wsl-store.png)
...
오늘(2021-01-20) 확인해보니 설치가 제대로 안됨. 되는 방법 찾기 귀찮으니 그냥 스토어 가서 까세영. 😒
