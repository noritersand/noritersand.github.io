...
- <http://docs.oracle.com/javase/10/docs/api/java/util/Properties.html>

Java Properties 클래스의 간단한 사용방법을 기술한 글.
...
사용방법은 해시맵과 거의 차이가 없지만 파일 입출력 기능을 지원하며 저장할 수 있는 값의 타입은 String으로만 지정할 수 있다. 보통 Properties 클래스는 Java 애플리케이션에서 사용될 상수를 텍스트 파일로 미리 작성한 뒤 필요한 곳에서 그 파일을 읽어오는데 사용된다.
