...
위 방법은 Neon.1a Release (4.6.1) 에선 통하지 않고 (🗓️ 2016-11-19 확인) 템플릿 변수 `${date}`를 다음처럼 작성해야 된다.
...
- [CodeMix](https://marketplace.eclipse.org/content/codemix): Python, PHP, JavaScript 등을 빠와하게 지원하는 확장 기능이다. 우와웅! 사실 안써봐서 좋은지는 몲.
